...
const STORY = [
  ...
  { id:"ch1", num:"第一章", title:"迷宮中的舞台", t:T.ch1, motif:"city", paras:[
    ...
    {t:"n",x:"婆婆憑空變出一個小盒子，遞到她手中，柔聲說道：「孩子，你不是這裡的人吧？帶著它，完成你的使命。」"},
    {t:"g",x:"「這盒子會替你引路。解開它的封印，命運之門便會在這座迷宮裡為你浮現。穿過那道門，到門後那座舞台來找我吧——我會在那裡等你。」"},
  ...
  { id:"ch2", num:"第二章", title:"拒絕入睡的森林", t:T.ch2, motif:"forest", paras:[
    ...
    {t:"n",x:"聲音漸漸淡去，盒蓋內側浮現出兩行細小的字跡，像是留給她的謎語："},
    {t:"ii",x:"森林甦醒的那一夜，萬物被點亮——"},
    {t:"ib",x:"其一：門前石碑只剩開頭的「20」還清晰，後兩個數字早被風雨磨去——那是森林化作不眠舞台的哪一年？\n其二：地底的庭院裡，棲息著幾隻自月宮而來的守望者——牠們各有各的模樣，替月亮看守著這道門。"},
    {t:"ic",x:"別信宮裡記得的那些數字——這道門，只認得這片土地上、妳親眼數過的東西。將這兩個數字依序相連，命運之門便會為妳開啟。"},
  ]},
...
const GATES = { 2:"0725", 3:"246", 4:"745", 5:"227" };
      ...
      <div style={{position:"relative",maxWidth:820,margin:"0 auto"}}>
        <Reveal>
          <div style={{textAlign:"center",marginBottom:"9vh"}}>
            ...
            <h2 style={{fontSize:"clamp(30px,6.5vw,52px)",fontWeight:700,color:c.t.ink,letterSpacing:"4px",margin:0,textShadow:`0 0 30px ${c.t.glow}30`,whiteSpace:idx===0?"nowrap":undefined}}>{c.title}</h2>
          </div>
        </Reveal>
  ...
  return (
    <div style={{position:"fixed",inset:0,zIndex:80,display:"flex",alignItems:"center",justifyContent:"center",padding:"24px 16px",overflowY:"auto",background:"radial-gradient(circle at 50% 32%, #1a1630 0%, #0a0a18 55%, #05060c 100%)",fontFamily:'-apple-system,"Noto Serif TC","Songti TC","Microsoft JhengHei",serif'}}>
      <div style={{width:"min(560px,92vw)",margin:"auto",background:"linear-gradient(135deg,#f4ecd6,#e6d8b6)",borderRadius:14,border:"1px solid #b0824a",boxShadow:"0 18px 50px #000a, inset 0 0 60px #b59f6d33",padding:"clamp(26px,5vw,44px) clamp(22px,5vw,40px)",color:"#3a2c18"}}>
        ...
        <Section label="故事概要">
          公主為了找尋相戀的王子，<br></br>不慎掉落傳說中的月中門，到了現實世界。<br/>
          為了完成自己的使命，公主將踏上旅程破解散落在捷運站的謎題，解開隱藏中的秘密，以及其背後所隱藏的含義。
        </Section>

        <Section label="遊戲方式">
          請依照場景和文字提示，推測目標捷運站。<br></br>
